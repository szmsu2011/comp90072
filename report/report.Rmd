...
```{r sszc, fig.height = 3.8, fig.cap = "Time series of chest movement (top) and heart rates (bottom) at 1Hz for 1 minute. Blue: naive zero-crossing; red: smoothing spline crossing. We can clearly see that smoothing spline gives a better count."}
```
