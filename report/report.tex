...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{r\_source }\OtherTok{\textless{}{-}} \FunctionTok{list.files}\NormalTok{(}\StringTok{"/R"}\NormalTok{, }\AttributeTok{full.names =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{purrr}\SpecialCharTok{::}\FunctionTok{map}\NormalTok{(r\_source[stringr}\SpecialCharTok{::}\FunctionTok{str\_detect}\NormalTok{(r\_source, }\StringTok{"}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{.R$"}\NormalTok{)], source)}
\end{Highlighting}
\end{Shaded}
