...
\caption{Visualisation in (Nakkiran et al., 2019): (a) Bias-variance tradeoff in classical methods. (b) Double descent loss curve from modern interpolating regime, potentially giving better predictions.}\label{fig:ddd}
\end{figure}
